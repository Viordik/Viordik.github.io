...
const routingComponents = [_order_courier_order_courier_component__WEBPACK_IMPORTED_MODULE_3__["OrderCourierComponent"], _list_order_list_order_component__WEBPACK_IMPORTED_MODULE_4__["ListOrderComponent"]];
...
let OrderCourierComponent = class OrderCourierComponent {
    constructor(itemService) {
        this.itemService = itemService;
        this.item = {
            adressFrom: '',
...
OrderCourierComponent.ctorParameters = () => [
    { type: _services_item_service__WEBPACK_IMPORTED_MODULE_2__["ItemService"] }
];
...
let ItemService = class ItemService {
    ...
    getItems() {
        return this.itemsCollection.snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(changes => {
